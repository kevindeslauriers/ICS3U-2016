 ...
 * This is a binary max-heap implementation of the priority queue ADT.
 */
import java.util.Arrays;

public class MaxBinaryHeap<T extends Comparable<T>> implements PriorityQueue<T> {
    private static final int DEFAULT_CAPACITY = 10;
    protected T[] array;
    protected int size;
    
    /**
     * Constructs a new MaxBinaryHeap.
     */
    ...
    protected void bubbleDown() {
        ...
        while (hasLeftChild(index)) {
            // which of my children is bigger?
